...
namespace hobby.Controllers
{
    public class UserController : Controller
    {
        ...
        public IActionResult Register(User userToCreate)
        {
            ...
            .Users
            .FirstOrDefault(user => user.UserName == userToCreate.UserName);
        ...
        public IActionResult Login(LoginUser userToLogin)
        {
            ...
            var foundUser = _context
                .Users
                .FirstOrDefault(user => user.UserName == userToLogin.LoginUserName);

            if(foundUser == null)
            {
                Console.WriteLine("user wasn't found");
                ModelState.AddModelError("LoginPassword", "Please check your Login User Name password."); 
                return View("LoginReg");
            }
