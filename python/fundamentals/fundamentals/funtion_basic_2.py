...
# print(first_plus_length([11,33,77,44,55]))

#4
# Values Greater than Second  
# Write a function that accepts a list and creates a new list containing only 
# the values from the original list that are greater than its 2nd value. Print how many values this is and 
# then return the new list. If the list has less than  e2lements, have the function return False
